...
INSERT INTO users (user_id,email,password,created_at,updated_at,deleted_at,last_session,first_name,last_name,phone,birthday,email_verified,phone_verified,gender,notification_email,notification_sms,subscription,referrer,reset_password_token) VALUES(1,'admin@test.com','$2a$10$zf2Ze2zPL5S8QPyAdcVaOOOWeb34yN8U/OSQwEqpiRJ3AjZnjs49K','"2019-11-10T06:09:48.161Z"','"2019-11-10T06:29:37.591Z"',null,'"2019-11-10T06:29:37.575Z"',null,null,null,null,false,false,null,false,false,false,null,null);
...
-- data pixart
INSERT INTO apps (app_id, title,a_category_id,created_at) VALUES (1,'Pixart',1,CURRENT_TIMESTAMP);
select setval('apps_app_id_seq', (select max(app_id) from apps));

--"PGPASSWORD=FylhtQ20022000 psql -h localhost -U pixelartadmin pixelart_db -f tables.sql"
